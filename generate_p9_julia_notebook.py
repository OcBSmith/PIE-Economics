...
nb.cells.append(
    nbf.v4.new_markdown_cell(
        r"""# LAB-P9: El Modelo de Crecimiento Óptimo de Ramsey (Julia)
...
nb.cells.append(
    nbf.v4.new_markdown_cell(r"""## 3. Calibración y Estado Estacionario""")
)
...
nb.cells.append(
    nbf.v4.new_markdown_cell(
        r"""## 5. Simulación de Transición ante Shocks de Productividad y Preferencias
...
nb.cells.append(
    nbf.v4.new_code_cell(
        r"""function plot_ramsey_simulation(A_final::Float64, beta_final::Float64)
...
nb.cells.append(
    nbf.v4.new_markdown_cell(
        r"""## 6. Precisión de Resolvedores: Blanchard-Khan frente a Solución No Lineal
...
nb.cells.append(
    nbf.v4.new_code_cell(r"""function plot_ramsey_comparison(A_shock::Float64)
    params = default_calibration(RamseyParams)
    ss_init = compute_ramsey_steady_state(params)
...
# 11. BUENAS PRÁCTICAS
nb.cells.append(
    nbf.v4.new_markdown_cell(r"""## 8. Buenas Prácticas Aplicadas en este Laboratorio
