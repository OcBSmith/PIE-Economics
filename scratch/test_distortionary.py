import numpy as np
from macroaicomp.models.fiscal_policy import FiscalPolicyParameters, solve_distortionary_foc, solve_distortionary_cvxpy
...
for t in range(5):
    print(f"{t:6d} | {res_foc['C'][t]:7.3f} | {res_cvxpy['C'][t]:7.3f} | {res_foc['L'][t]:7.3f} | {res_cvxpy['L'][t]:7.3f} | {res_foc['B'][t]:7.3f} | {res_cvxpy['B'][t]:7.3f}")
