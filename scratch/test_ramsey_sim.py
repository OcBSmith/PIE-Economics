...
def solve_ramsey_linearized(params, k0, A_final=1.0, n_final=0.02, beta_final=0.97, T=100, t_shock=0):
...
res_lin = solve_ramsey_linearized(params, ss_init["k"], A_final=1.05, T=T, t_shock=t_shock)
...
print(f"res_lin k_hat ratio: {res_lin['c_hat'][t_shock] / res_lin['k_hat'][t_shock]:.6f} (expected: 0.575075)")
