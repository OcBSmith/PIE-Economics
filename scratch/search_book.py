with open(
    r"c:\Users\AntonioRC\Desktop\PIE\book_extracted.txt",
    "r",
    encoding="utf-8",
    errors="ignore",
) as f:
...
with open(
    r"c:\Users\AntonioRC\Desktop\PIE\scratch\chapter7.txt", "w", encoding="utf-8"
) as f:
...
with open(
    r"c:\Users\AntonioRC\Desktop\PIE\scratch\appendix_k.txt", "w", encoding="utf-8"
) as f:
