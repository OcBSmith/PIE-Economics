...
def solve_ramsey_linearized_proposed(
...
def solve_ramsey_nonlinear_fixed(params, k0, A_path, n_path, T=100, t_shock=0):
    ...
    def _residuals(c_shock_arr):
        ...
        print(
            f"c_shock: {c_shock_arr[0]:.6f}, final k: {k_sim[-1]:.6f}, k_ss_final: {k_ss_final:.6f}, residual: {res:.6f}"
        )
        return [res]
...
res_lin = solve_ramsey_linearized_proposed(
...
res_nonlin = solve_ramsey_nonlinear_fixed(
