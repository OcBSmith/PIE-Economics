...
def test_plot():
    ...
    axs[0].set_title('Evolución Temporal del Producto Real (Y)', fontsize=12, fontweight='bold', pad=10)
    ...
    axs[1].plot(res.t, P_path, color='#8EAD3A', linewidth=2.5, label='Nivel de Precios (P)')
    ...
    axs[1].set_title('Evolución Temporal del Nivel de Precios (P)', fontsize=12, fontweight='bold', pad=10)
    ...
    axs[2].set_title('Diagrama de Fases en el Plano (Y, P)', fontsize=12, fontweight='bold', pad=10)
    ...
    plt.tight_layout()
    os.makedirs("C:/Users/AntonioRC/.gemini/antigravity-ide/brain/0fdfe251-07a4-4597-9b29-043dac53e81a", exist_ok=True)
    plt.savefig("C:/Users/AntonioRC/.gemini/antigravity-ide/brain/0fdfe251-07a4-4597-9b29-043dac53e81a/test_phase_diagram.png", dpi=150, bbox_inches='tight')
